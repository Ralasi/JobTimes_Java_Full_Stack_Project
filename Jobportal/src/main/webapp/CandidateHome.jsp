	...
	%>
     ...
     <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
      ...
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h2 class="display-4">FIND YOUR PERFECT JOB MATCH! </h2>
        <p class="lead">Search results tuned precisely to the criteria you set so we can better connect you with relevant and personalized tech positions.</p>
        <br>
        <div>
          <a class="btn btn-primary btn-lg" href="CandFindJobs.jsp" role="button">Search Jobs</a>
        </div>
      </div>
