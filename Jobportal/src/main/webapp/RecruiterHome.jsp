	...
	%>
     ...
     <div class="container-xxl bg-white p-0">
      ...
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h2 class="display-4">LET'S MAKE YOUR NEXT GREAT HIRE. <em>FAST</em> </h2>
        <p class="lead">We help more businesses make hires than any other online recruiting tool.</p>
        <br>
        <div>
          <a class="btn btn-primary btn-lg" href="RecPostJob.jsp" role="button">Post Job</a>
        </div>
      </div>
